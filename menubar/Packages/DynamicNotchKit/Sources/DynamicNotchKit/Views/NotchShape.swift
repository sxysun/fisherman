...
// #Preview stripped: the #Preview macro requires the PreviewsMacros
// plugin which only ships with full Xcode (not CommandLineTools).
// Previews aren't used at runtime in this app.
